 ...
 *  PROXY (ffmpeg). Conteúdo decodificável apresenta um quadro em dezenas de ms;
 *  este teto só é atingido quando NÃO há decoder (ProRes/MXF). Curto de propósito:
 *  é o tempo de tela preta antes de o still/proxy assumir — na prévia e na troca
 *  de ângulo do monitor. */
