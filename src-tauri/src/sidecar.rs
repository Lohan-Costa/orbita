...
impl SidecarManager {
    ...
    pub fn start(&self) -> Result<(), String> {
        ...
        // O sidecar não herda o PATH de um shell de dev quando o app é instalado.
        // Passamos o ffmpeg/ffprobe EMBARCADOS por env — é o que faz o sync rodar
        // numa máquina sem ffmpeg instalado. Em dev os binários não existem ao lado
        // do exe e `ffbins` devolve o nome cru, que o `shutil.which` do sidecar
        // resolve pelo PATH.
        cmd.env("ORBITA_FFMPEG", crate::ffbins::ffmpeg());
        cmd.env("ORBITA_FFPROBE", crate::ffbins::ffprobe());
