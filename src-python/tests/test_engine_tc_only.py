...
SND = str(Path("/fake/snd.wav"))          # TC 0 s — cobre as câmeras
SND_FAR = str(Path("/fake/snd_far.wav"))  # TC 3600 s (1 h) — não cobre câmera nenhuma
CAM1 = str(Path("/fake/camA/cam1.mov"))   # TC 00:00:05:00 → 5 s
CAM2 = str(Path("/fake/camB/cam2.mov"))   # TC 00:00:08:00 → 8 s
CAM_NO_TC = str(Path("/fake/camC/cam3.mov"))  # sem TC
SND_DUR_S = 40.0
CAM_DUR_S = 10.0
