...
REM --- 4/5 Python (necessario para construir o sidecar) ---
where python >nul 2>&1
if errorlevel 1 (
  echo [4/5] Python nao encontrado. Vou instalar.
  winget install --id Python.Python.3.12 -e --accept-source-agreements --accept-package-agreements
) else (
  echo [4/5] Python ja instalado. Ok.
)
...
echo.
echo [5/5] Verificando o sidecar Python...
